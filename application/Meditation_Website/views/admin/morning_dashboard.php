...
<div class="container">
    <div class="row">
        <div class="col-lg-6">
            <h4 class="text-primary text-center">You currently have <?= count($show_count) ?> morning session<?php if(count($show_count)==1)
                    {
                        echo ' ';
                    }
                    else
        ...
        <div class="col-lg-6">
            <?= anchor('morningsession/add_session','Add Session',['class'=>'btn btn-lg btn-primary pull-right']) ?>
        </div>
    </div>
