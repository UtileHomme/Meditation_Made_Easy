...
class Admin extends MY_Controller
{
    public function dashboard()
    {
        ...
        //to make returned data accessible in view
    ...
    public function store_article()
    {
        $config =
        [
            'upload_path' => '/var/www/codeigniter/uploads',
            'allowed_types' => 'jpg|gif|png|jpeg',
        ];

        $this->load->library('upload',$config);
        //rules set in config are passed as parameters
        if($this->form_validation->run('add_article_rules') && $this->upload->do_upload())
        {
            $post = $this->input->post();
            //Submit button is also going as an array, we need to remove it
            unset($post['submit']);
            ...
            //     "Articles Failed to Add, Please try again"
            // );

            //repetitive code written in all functions
            ...
            {
                $this->session->set_flashdata('feedback','Articles Failed to Add, Please try again');
    ...
    public function update_article($article_id)
    {
        ...
        if($this->form_validation->run('add_article_rules'))
        {
            ...
            //     "Articles Failed to Updated, Please try again"
            // );
            ...
            {
                $this->session->set_flashdata('feedback','Articles Failed to Updated, Please try again');
                $this->session->set_flashdata('feedback_class', 'alert-danger');
            }
            return redirect('admin/dashboard');
        }
    ...
    public function delete_article()
    {
        ...
        //     "Articles Failed to Delete, Please try again"
        // );
        ...
        {
            $this->session->set_flashdata('feedback','Articles Failed to Delete, Please try again');
            $this->session->set_flashdata('feedback_class', 'alert-danger');
        }
        return redirect('admin/dashboard');
    ...
    /*
    //repetitive code taken care of here
